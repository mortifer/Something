...
class SalesPointStatistics extends React.Component {
    render() {
        const { form, salesPointStatistics, salesPointStatisticsUpdating, dispatch, error } = this.props;
        ...
        return (
            <div className="lightpage">
                <div className="lightpage_back"><h2><Link to={"/" + organizationId + "/Statistics"} className="link">Статистика</Link></h2></div>
                <Link to={"/" + organizationId + "/Statistics"} className="lightpage_close"></Link>
